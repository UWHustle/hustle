...
#ifndef HUSTLE_FUSED_JOIN_H
#define HUSTLE_FUSED_JOIN_H
...
class FusedJoin : public Operator {
 public:
  /**
   ...
   */
  FusedJoin(const std::size_t query_id,
 ...
 private:
  ...
  std::vector<std::shared_ptr<BloomFilter>> right_filters_;
