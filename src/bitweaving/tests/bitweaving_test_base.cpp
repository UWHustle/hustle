...
//            arrow::MemoryPool *pool = arrow::default_memory_pool();
            ...
            //write_to_file("./data/date.hsl", date);
            date        = read_from_file("/Users/sandhyakannan/Masters/RA/Project/Arrow-Bitweaving/cpp/data/date.hsl", false);
            //lineorder   = build_table(folder_path + "lineorder.tbl", pool, lineorder_schema);
            //write_to_file("./data/lineorder.hsl", lineorder);
            lineorder   = read_from_file("/Users/sandhyakannan/Masters/RA/Project/Arrow-Bitweaving/cpp/data/lineorder.hsl", false);
            ...
            // Fill the bitweaving tables with columns from the arrow tables.
            addColumnsToBitweavingTable(lineorder, lineorder_table);
            //addColumnsToBitweavingTable(customer, customer_table);
            addColumnsToBitweavingTable(date, date_table);
            //addColumnsToBitweavingTable(part, part_table);
            //addColumnsToBitweavingTable(supplier, supplier_table);
