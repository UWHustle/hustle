...
TEST(ResolverSSBTest, ssb_qtemp) {
  init();
  hustle::HustleDB hustleDB("db_directory");
  ...
  std::cout << "Plan:" << resolver->to_string(4) << std::endl;

  // TODO(Lichengxi): build validation plan

}

TEST(ResolverSSBTest, ssb_q1) {
  init();
  hustle::HustleDB hustleDB("db_directory");
