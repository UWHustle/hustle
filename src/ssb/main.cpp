...
void run_experiment(int sf, int num_trials=1, bool load=false, bool print=false) {
...
//    return 0;
    if (argc == 5) {
        run_experiment(std::stoi(argv[1]), std::stoi(argv[2]), std::stoi(argv[3]), std::stoi(argv[4]));
    } else if (argc == 4) {
